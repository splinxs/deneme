...
function template_main()
{
 ...
 ', $category['link'], '
                                       ...
                                       <div class="headercat">
 <img src="', $settings['images_url'], '/prlKategori/', $category['id'], '.jpg" alt="category" width="100%"/>
 </div>
               </td>
            </tr>
         </tbody>';
         ...
         <div class="title_barIC">
            <h4 class="titlebg">
               <span class="ie6_header floatleft">
                  <a href="', $scripturl, '?action=recent"><img class="icon" src="', $settings['images_url'], '/icons/recent.gif" alt="', $txt['recent_posts'], '" /></a>
                  ', $txt['recent_posts'], '
               </span>
            </h4>
         </div>
