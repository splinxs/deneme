...
function template_main()
{
   ...
   <div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
      ...
      <div class="table_frame">
         <table class="table_list">
            ...
            <tr class="section-header">
               <td colspan="2">', $txt['board'], '</td>
               <td class="righttext">', $txt['latest'], '</td>
               <td>', $txt['stats'], '</td>
            </tr>';
      ...
      foreach ($context['boards'] as $board)
      {
         ...
         if (!empty($board['last_post']['id']))
            echo '
                  <p><span>', $board['last_post']['member']['link'], ' ', $txt['in'], ' <span>', $board['last_post']['link'], '</span></span><br />
   ...
   <div class="tborder topic_table" id="messageindex">
      ...
      {
         echo '
               <th colspan="2" scope="col" class="lefttext"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=subject', $context['sort_by'] == 'subject' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['subject'], $context['sort_by'] == 'subject' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a> / <a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=starter', $context['sort_by'] == 'starter' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['started_by'], $context['sort_by'] == 'starter' ? ' <img src="' . $settings['images_url'] . '/sort_' . $context['sort_direction'] . '.gif" alt="" />' : '', '</a></th>
               <th scope="col" class="righttext" width="24%"><a href="', $scripturl, '?board=', $context['current_board'], '.', $context['start'], ';sort=last_post', $context['sort_by'] == 'last_post' && $context['sort_direction'] == 'up' ? ';desc' : '', '">', $txt['latest'], '</a></th>';
      ...
      foreach ($context['topics'] as $topic)
      {
            ...
            <tr>
               ...
               <td class="subject ', $alternate_class, '">
                  <div ', (!empty($topic['quick_mod']['modify']) ? 'id="topic_' . $topic['first_post']['id'] . '" onmouseout="mouse_on_div = 0;" onmouseover="mouse_on_div = 1;" ondblclick="modify_topic(\'' . $topic['id'] . '\', \'' . $topic['first_post']['id'] . '\');"' : ''), '>
                     ', $topic['is_sticky'] ? '<strong>' : '', '<span class="subject-title" id="msg_' . $topic['first_post']['id'] . '">', $topic['first_post']['link'], (!$context['can_approve_posts'] && !$topic['approved'] ? '&nbsp;<em>(' . $txt['awaiting_approval'] . ')</em>' : ''), '</span>', $topic['is_sticky'] ? '</strong>' : '';
         ...
         echo '
               ...
               <td class="lastpost ', $color_class, '">
                  <span>', $txt['by'], ' ', $topic['last_post']['member']['link'], '</span> <a href="', $topic['last_post']['href'], '"><img src="', $settings['images_url'], '/icons/last_post.gif" alt="', $txt['last_post'], '" title="', $txt['last_post'], '" /></a><br />
                  ', $topic['last_post']['time'], '
               </td>
               <td class="stats ', $alternate_class, '">
                  <span>', $topic['replies'], ' ', $txt['replies'], '</span>
                  <br />
