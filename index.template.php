...
echo '
   <div id="dd">
    ...
    <div class="haber">
  <a href="#"><img src="https://www.upload.ee/image/11126448/sevgililergunu-gtamulti.png"></a>
    <a href="#"><h2>PRL Theme Demo Haber</h2></a><p class="haberaciklamasi" style="">PRL Theme PRL Theme PRL Theme PRL Theme PRL Theme PRL Theme PRL Theme.</p><p class="habertag" style="
    background: #bb3333;
    padding: 1px 5px;
    margin: 5px 0;
    color: #ffffff;
...
echo '
   <div id="footer">
      ...
      <div class="footeralan">
                <h6 class="headerprl">Sosyal Medya</h6>
                <ul class="footer-ul">
                  <li><a href="https://www.GTAMulti.com/forum/">Instagram</a></li>
                  
<li><a href="sartlar.php">Facebook</a></li>
<li><a href="sartlar.php">Twitter</a></li>
<li><a href="sartlar.php">Twitch</a></li>
<li><a href="sartlar.php">YouTube</a></li><li><a href="sartlar.php">Steam</a></li>
                  
                </ul>
              </div>
           
           <div class="footeralan">
                <h6 class="headerprl">Site</h6>
                <ul class="footer-ul">
                  <li><a href="https://www.GTAMulti.com/forum/">Market</a></li>
                  <li><a href="sartlar.php">Karakter Paneli</a></li>
                  <li><a href="#">Harita</a></li>
                </ul>
              </div>
      
      <div class="footeralan">
                <h6 class="headerprl">XX Roleplay</h6>
                <ul class="footer-ul">
                  <li><a href="https://www.GTAMulti.com/forum/">PRL</a></li>
                  <li><a href="sartlar.php">PRL</a></li>
                  <li><a href="#">PRL</a></li>
                </ul>
              </div>
